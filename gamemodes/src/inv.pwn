		...
		case DIALOG_PLAYER_POCKETS:
		{
			if(response)
			{
				...
				switch(pTemp(playerid)[pt_INVENTORY_POCKET_TYPE])
				{
					...
					case INVENTORY_TYPE_PHONE_RESOLVER:
					{
						if(!PI[playerid][pPHONE_RESOLVER]) return SendMessage(playerid, "No tienes una guía telefonica, puedes ir a cualquier 24/7 para comprar una.");
					}
					case INVENTORY_TYPE_MECHANIC_PIECES:
					{
						if(PI[playerid][pMECHANIC_PIECES] <= 0) return SendMessage(playerid, "No tienes piezas.");
					}
					case INVENTORY_TYPE_FUEL_DRUM:
					{
						if(PI[playerid][pFUEL_DRUM] <= 0) return SendMessage(playerid, "No tienes gasolina en el bidon.");
					}
					...
					case INVENTORY_TYPE_MECHANIC_PIECES:
					{
						switch(pTemp(playerid)[pt_INVENTORY_POCKET_OPTION])
						{
							case 0:
							{
								...
								ShowPlayerDialog(playerid, DIALOG_POCKETS_EXTRA, DIALOG_STYLE_INPUT, "Inventario - Cantida de piezas", "{d1d1d1}Escribe la cantidad de piezas que quieres dar:", "Confirmar", "Cancelar");
							}
						}
					}
					case INVENTORY_TYPE_FUEL_DRUM:
					...
					case INVENTORY_TYPE_SEED_MEDICINE:
					{
						switch(pTemp(playerid)[pt_INVENTORY_POCKET_OPTION])
						{
							case 0:
							{
								...
								ShowPlayerDialog(playerid, DIALOG_POCKETS_EXTRA, DIALOG_STYLE_INPUT, "Inventario - Cantida de semillas", "{d1d1d1}Escribe la cantidad de semillas que quieres dar:", "Confirmar", "Cancelar");
							}
						}
					}
					case INVENTORY_TYPE_SEED_CANNABIS:
			...
			if(response)
			{
				...
				switch(pTemp(playerid)[pt_INVENTORY_POCKET_TYPE])
				{
					...
					case INVENTORY_TYPE_MECHANIC_PIECES:
					{
						...
						PI[ pTemp(playerid)[pt_INVENTORY_POCKET_EXTRA_0] ][pMECHANIC_PIECES] += strval(inputtext);
					...
					case INVENTORY_TYPE_SEED_MEDICINE:
					{
						...
						PI[ pTemp(playerid)[pt_INVENTORY_POCKET_EXTRA_0] ][pSEED_MEDICINE] += strval(inputtext);
					...
					case INVENTORY_TYPE_SEED_CANNABIS:
					{
						...
						PI[ pTemp(playerid)[pt_INVENTORY_POCKET_EXTRA_0] ][pSEED_CANNABIS] += strval(inputtext);
					...
					case INVENTORY_TYPE_SEED_CRACK:
					{
						...
						PI[ pTemp(playerid)[pt_INVENTORY_POCKET_EXTRA_0] ][pSEED_CRACK] += strval(inputtext);
