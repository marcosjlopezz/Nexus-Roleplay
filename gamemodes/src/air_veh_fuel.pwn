            ...
            if(response) {
                switch(listitem) {
                    case 0: {
                        ...
                        pAirVehFuelingTimer[playerid] = SetTimerEx("OnVehAirRefuellingUpdate", 1000, true, "ii", playerid, PLAYER_TEMP[playerid][pt_SELECTED_MECHANIC_VEHICLE_ID]);
                    }
                    case 1: {
                    ...
                    case 2, 3: {
                        ...
                        if(PLAYER_VEHICLES[vehicleid][player_vehicle_VALID] && PLAYER_VEHICLES[vehicleid][player_vehicle_OWNER_ID] == PI[playerid][pID]) {
                            PLAYER_TEMP[playerid][pt_MECHANIC_COLOR_SLOT] = listitem - 2;
