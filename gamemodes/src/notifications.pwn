...
stock MinPosYNotification(playerid, TDN)
{
    if(TDN == 0)
    {
        TextDrawsNotification[playerid][TDN][MinPosY] = PI[playerid][pWANTED_LEVEL] == 0 ? 130.000000 : 153.0;
    }
    else
    {
...
stock CreateTDN(playerid, TDN)
{
    if(TextDrawsNotification[playerid][TDN][Use] == 1)
    {
        ...
        PlayerTextDrawBackgroundColor(playerid, TextDrawsNotification[playerid][TDN][TextDraw], 0x000000FF);
        PlayerTextDrawBoxColor(playerid, TextDrawsNotification[playerid][TDN][TextDraw], 0x000000FF);
